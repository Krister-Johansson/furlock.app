          ...
          <Card>
            <CardHeader>
              <div className="flex items-center gap-2">
                <Users
                  ...
                  aria-hidden="true"
                />
                <CardTitle className="text-base">Key holder shares</CardTitle>
              </div>
              <CardDescription>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="rounded-md bg-muted/50 border border-border p-3 text-sm text-muted-foreground">
                Any <strong className="text-foreground">{threshold}</strong> of{' '}
                <strong className="text-foreground">{totalShares}</strong> key
                holders can decrypt the document for read access.
              </div>
            </CardContent>
          </Card>
            ...
            <Button
              ...
              onClick={() =>
                navigate({
                  ...
                  state: (prev) => ({ ...prev, masterKey: creationResult.masterToken }),
                  replace: true,
                })
              }
            >
